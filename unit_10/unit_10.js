...
let ar1 = ['string', 'string2', 55, -5, true];
function f1() {
...
let ar2 = ['string', 'string2', 55, -5, true];
function f2() {
    let out = '';
...
let ar16_odd = [];
let ar16_even = [];
outEven = document.querySelector('.out-16-even');
outOdd = document.querySelector('.out-16-odd');
