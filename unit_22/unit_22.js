...
function t3() {
    ...
    try {
        ...
        document.querySelector("body > div.container > section:nth-child(6)").append(div03);
        div03.innerHTML = a * b;
    }
}
...
function t4() {
    ...
    document.querySelector('.out-4').innerHTML = out04;
}
...
function t5() {
    ...
    let out05_01 = document.querySelector('.out-5-1');
    try {
        p.push(3);
    }
    catch (error) {
