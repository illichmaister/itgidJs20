...
let input01 = document.querySelector('.i-1');
let output01 = document.querySelector('.out-1');

function f1() {
    if (input01.value == 4) {
        output01.innerHTML = true;
    }
    else {
        output01.innerHTML = false;
    };
}
...
function f4() {
    let ageCount = 2020 - input04.value;
    if (ageCount >= 18) {
        out04.innerHTML = 1;
...
let input06 = document.querySelector('.i-6');
let out06 = document.querySelector('.out-6');

function f6() {
    if (input06.value % 2 == 0) {
        out06.innerHTML = 'even';
    }
    else {
        out06.innerHTML = 'odd';
    }
...
let input07_01 = document.querySelector('.i-71');
let input07_02 = document.querySelector('.i-72');
let out07 = document.querySelector('.out-7');

function f7() {
    out07.innerHTML = Math.pow(input07_01.value, input07_02.value);
}
...
function f8() {
    let input08 = document.querySelector('.s-8').value;
    // console.log(input08);
    switch (+input08) {
        case 1:
            out08.innerHTML = 'one';
...
function f9() {
    let input09 = document.querySelector('.i-9').value;
    if (input09 >= 1 && input09 <= 32) {
        out09.innerHTML = 1;
    }
    else if (input09 >= 33 && input09 <= 43) {
        out09.innerHTML = 2;
    }
    else if (input09 >= 44 && input09 <= 64) {
        out09.innerHTML = 3;
    }
    else {
        out09.innerHTML = 0;
...
function f10() {
    let input10 = document.querySelector('.s-100').value;
...
function f11() {
    let input11 = document.querySelector('.s-110').value;
    out11.innerHTML = input11;
}
...
function f13() {
    let input13 = document.querySelector('.i-130').value; //нужен + перед document.querySel...
    out13.innerHTML = (typeof input13);
}
...
function f14() {
    let firstNum = +document.querySelector('.i-141').value;
    let secondNum = +document.querySelector('.i-142').value;
    let mathSym = document.querySelector('.s-143').value;

    if (mathSym == '+') {
        out14.innerHTML = firstNum + secondNum;
    }
    else if (mathSym == '-') {
        out14.innerHTML = firstNum - secondNum;
    }
...
function f15() {
    let firstNum = +document.querySelector('.s-151').value;
    let secondNum = +document.querySelector('.s-152').value;
    let logOper = document.querySelector('.s-153').value;
    switch (logOper) {
        case '&&':
            out15.innerHTML = firstNum && secondNum;
            break;
        default:
            out15.innerHTML = firstNum || secondNum;
    }
