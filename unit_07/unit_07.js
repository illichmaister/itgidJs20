...
function t4(year) {
    return dateYear.getFullYear() - year;
}
...
document.querySelector('.b-9').onclick = function () {
    document.querySelector('.out-9').textContent = t9(7);
}
...
document.querySelector('.b-10').onclick = function () {
    document.querySelector('.out-10').textContent = t10(15, 1);
}

// почему отрицательные числа и 0 игнорируются при этой логике?
