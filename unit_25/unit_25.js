...
//     let a = { auth: '5ADcB96BA48d3f80', name: "Illia", num1: 3, num2: 45, year: 1987, m: 1, d: 1, y: 1 };
//     for (let key in a) {
//         parameters += key + "=" + a[key] + "&";
//     }
//     parameters = parameters.substring(0, parameters.length - 1) + '&action=';
...
function t1() {
    ...
    xhttp.open("GET", `${server}${auth}action=1`);
    xhttp.send();
